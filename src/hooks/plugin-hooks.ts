...
import type { OpenHedgehogPluginApi } from "../plugins/types.js";
...
function resolveHookDir(api: OpenHedgehogPluginApi, dir: string): string {
...
function normalizePluginHookEntry(api: OpenHedgehogPluginApi, entry: HookEntry): HookEntry {
  return {
    ...entry,
    hook: {
      ...entry.hook,
