...
function resolveExecConfig(cfg: OpenHedgehogConfig | undefined) {
...
export function createOpenHedgehogCodingTools(options?: {
  ...
  const base = (codingTools as unknown as AnyAgentTool[]).flatMap((tool) => {
    if (tool.name === readTool.name) {
      ...
      return [createOpenHedgehogReadTool(freshReadTool)];
    }
