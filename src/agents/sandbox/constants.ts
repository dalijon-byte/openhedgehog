...
export const DEFAULT_SANDBOX_WORKSPACE_ROOT = path.join(os.homedir(), ".openhedgehog", "sandboxes");

export const DEFAULT_SANDBOX_IMAGE = "openhedgehog-sandbox:bookworm-slim";
export const DEFAULT_SANDBOX_CONTAINER_PREFIX = "openhedgehog-sbx-";
...
export const DEFAULT_SANDBOX_BROWSER_IMAGE = "openhedgehog-sandbox-browser:bookworm-slim";
export const DEFAULT_SANDBOX_COMMON_IMAGE = "openhedgehog-sandbox-common:bookworm-slim";

export const DEFAULT_SANDBOX_BROWSER_PREFIX = "openhedgehog-sbx-browser-";
...
const resolvedSandboxStateDir = STATE_DIR ?? path.join(os.homedir(), ".openhedgehog");
