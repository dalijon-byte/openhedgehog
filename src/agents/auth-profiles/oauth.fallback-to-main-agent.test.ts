...
describe("resolveApiKeyForProfile fallback to main agent", () => {
  ...
  beforeEach(async () => {
    ...
    // Set environment variables so resolveOpenHedgehogAgentDir() returns mainAgentDir
    process.env.OPENHEDGEHOG_STATE_DIR = tmpDir;
    process.env.OPENHEDGEHOG_AGENT_DIR = mainAgentDir;
