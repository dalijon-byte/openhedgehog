...
describe("createOpenHedgehogCodingTools", () => {
  ...
  it("gates apply_patch behind tools.exec.applyPatch for OpenAI models", () => {
    const config: OpenHedgehogConfig = {
      tools: {
        exec: {
    ...
    const openAiTools = createOpenHedgehogCodingTools({
      config,
    ...
    const anthropicTools = createOpenHedgehogCodingTools({
      config,
  ...
  it("respects apply_patch allowModels", () => {
    ...
    const allowed = createOpenHedgehogCodingTools({
      config,
      modelProvider: "openai",
      modelId: "gpt-5.2",
    });
    ...
    const denied = createOpenHedgehogCodingTools({
      config,
      modelProvider: "openai",
      modelId: "gpt-5-mini",
    });
