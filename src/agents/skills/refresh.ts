...
function resolveWatchPaths(workspaceDir: string, config?: OpenHedgehogConfig): string[] {
  const paths: string[] = [];
...
export function ensureSkillsWatcher(params: { workspaceDir: string; config?: OpenHedgehogConfig }) {
