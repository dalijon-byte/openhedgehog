...
describe("Agent-specific tool filtering", () => {
    ...
    const cfg: OpenHedgehogConfig = {
      ...
      agents: {
        list: [
          {
            id: "restricted",
            workspace: "~/openhedgehog-restricted",
            tools: {
  ...
  it("should allow different tool policies for different agents", () => {
    ...
    const mainTools = createOpenHedgehogCodingTools({
      config: cfg,
      sessionKey: "agent:main:main",
    ...
    const familyTools = createOpenHedgehogCodingTools({
      config: cfg,
  ...
  it("should apply group tool policy overrides (group-specific beats wildcard)", () => {
    ...
    const trustedTools = createOpenHedgehogCodingTools({
      config: cfg,
  ...
  it("should apply per-sender tool policies for group tools", () => {
    ...
    const aliceTools = createOpenHedgehogCodingTools({
      config: cfg,
    ...
    const bobTools = createOpenHedgehogCodingTools({
      config: cfg,
      sessionKey: "agent:main:whatsapp:group:family",
      senderId: "bob",
  ...
  it("should not let default sender policy override group tools", () => {
    ...
    const adminTools = createOpenHedgehogCodingTools({
      config: cfg,
