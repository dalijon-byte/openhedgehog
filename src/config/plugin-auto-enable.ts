import type { OpenHedgehogConfig } from "./config.js";
...
function isTelegramConfigured(cfg: OpenHedgehogConfig, env: NodeJS.ProcessEnv): boolean {
...
function isDiscordConfigured(cfg: OpenHedgehogConfig, env: NodeJS.ProcessEnv): boolean {
...
function isSlackConfigured(cfg: OpenHedgehogConfig, env: NodeJS.ProcessEnv): boolean {
  if (
...
function isSignalConfigured(cfg: OpenHedgehogConfig): boolean {
...
function isIMessageConfigured(cfg: OpenHedgehogConfig): boolean {
...
function isWhatsAppConfigured(cfg: OpenHedgehogConfig): boolean {
...
function isGenericChannelConfigured(cfg: OpenHedgehogConfig, channelId: string): boolean {
...
function collectModelRefs(cfg: OpenHedgehogConfig): string[] {
  const refs: string[] = [];
...
function isProviderConfigured(cfg: OpenHedgehogConfig, providerId: string): boolean {
...
function isPluginExplicitlyDisabled(cfg: OpenHedgehogConfig, pluginId: string): boolean {
  const entry = cfg.plugins?.entries?.[pluginId];
  return entry?.enabled === false;
}

function isPluginDenied(cfg: OpenHedgehogConfig, pluginId: string): boolean {
...
function ensureAllowlisted(cfg: OpenHedgehogConfig, pluginId: string): OpenHedgehogConfig {
...
function enablePluginEntry(cfg: OpenHedgehogConfig, pluginId: string): OpenHedgehogConfig {
  const entries = {
    ...cfg.plugins?.entries,
    [pluginId]: {
