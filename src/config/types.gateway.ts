...
export type WideAreaDiscoveryConfig = {
  enabled?: boolean;
  /** Optional unicast DNS-SD domain (e.g. "openhedgehog.internal"). */
  domain?: string;
};
...
export type CanvasHostConfig = {
  enabled?: boolean;
  /** Directory to serve (default: ~/.openhedgehog/workspace/canvas). */
  root?: string;
...
export type GatewayControlUiConfig = {
  ...
  enabled?: boolean;
  /** Optional base path prefix for the Control UI (e.g. "/openhedgehog"). */
  basePath?: string;
...
export type GatewayConfig = {
  /** Single multiplexed port for Gateway WS + HTTP (default: 18798). */
  port?: number;
  /**
