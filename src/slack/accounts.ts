...
export function listSlackAccountIds(cfg: OpenHedgehogConfig): string[] {
...
export function resolveDefaultSlackAccountId(cfg: OpenHedgehogConfig): string {
...
function mergeSlackAccountConfig(cfg: OpenHedgehogConfig, accountId: string): SlackAccountConfig {
...
export function listEnabledSlackAccounts(cfg: OpenHedgehogConfig): ResolvedSlackAccount[] {
