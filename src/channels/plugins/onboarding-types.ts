...
export type ChannelOnboardingDmPolicy = {
  ...
  policyKey: string;
  allowFromKey: string;
  getCurrent: (cfg: OpenHedgehogConfig) => DmPolicy;
  setPolicy: (cfg: OpenHedgehogConfig, policy: DmPolicy) => OpenHedgehogConfig;
...
export type ChannelOnboardingAdapter = {
  ...
  disable?: (cfg: OpenHedgehogConfig) => OpenHedgehogConfig;
};
