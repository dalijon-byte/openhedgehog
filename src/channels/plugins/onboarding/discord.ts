...
function setDiscordDmPolicy(cfg: OpenHedgehogConfig, dmPolicy: DmPolicy) {
  const allowFrom =
...
function setDiscordAllowFrom(cfg: OpenHedgehogConfig, allowFrom: string[]): OpenHedgehogConfig {
  return {
    ...cfg,
    channels: {
      ...cfg.channels,
