...
export const DEFAULT_LOG_DIR = "/tmp/openhedgehog";
export const DEFAULT_LOG_FILE = path.join(DEFAULT_LOG_DIR, "openhedgehog.log"); // legacy single-file path

const LOG_PREFIX = "openhedgehog";
...
function resolveSettings(): ResolvedSettings {
  let cfg: OpenHedgehogConfig["logging"] | undefined =
    (loggingState.overrideSettings as LoggerSettings | null) ?? readLoggingConfig();
  if (!cfg) {
    try {
      const loaded = requireConfig("../config/config.js") as {
        loadConfig?: () => OpenHedgehogConfig;
      };
