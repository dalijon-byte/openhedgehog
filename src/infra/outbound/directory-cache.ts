...
export class DirectoryCache<T> {
  ...
  private lastConfigRef: OpenHedgehogConfig | null = null;

  constructor(private readonly ttlMs: number) {}

  get(key: string, cfg: OpenHedgehogConfig): T | undefined {
  ...
  set(key: string, value: T, cfg: OpenHedgehogConfig): void {
    this.resetIfConfigChanged(cfg);
  ...
  clear(cfg?: OpenHedgehogConfig): void {
    this.cache.clear();
    if (cfg) {
  ...
  private resetIfConfigChanged(cfg: OpenHedgehogConfig): void {
