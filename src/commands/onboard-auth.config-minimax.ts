...
export function applyMinimaxProviderConfig(cfg: OpenHedgehogConfig): OpenHedgehogConfig {
...
export function applyMinimaxConfig(cfg: OpenHedgehogConfig): OpenHedgehogConfig {
