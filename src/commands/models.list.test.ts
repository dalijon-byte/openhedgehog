...
const ensureOpenHedgehogModelsJson = vi.fn().mockResolvedValue(undefined);
const resolveOpenHedgehogAgentDir = vi.fn().mockReturnValue("/tmp/openhedgehog-agent");
...
vi.mock("../config/config.js", () => ({
  ...
  STATE_DIR: "/tmp/openhedgehog-state",
  loadConfig,
}));

vi.mock("../agents/models-config.js", () => ({
  ensureOpenHedgehogModelsJson,
}));

vi.mock("../agents/agent-paths.js", () => ({
  resolveOpenHedgehogAgentDir,
}));
