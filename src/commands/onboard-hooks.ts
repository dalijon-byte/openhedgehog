...
export async function setupInternalHooks(
  ...
  await prompter.note(
    [
      ...
      "",
      "Learn more: https://docs.openhedgehog.ai/hooks",
    ].join("\n"),
    "Hooks",
  );
  ...
  await prompter.note(
    [
      ...
      `  ${formatCliCommand("openhedgehog hooks list")}`,
      `  ${formatCliCommand("openhedgehog hooks enable <name>")}`,
      `  ${formatCliCommand("openhedgehog hooks disable <name>")}`,
    ].join("\n"),
    "Hooks Configured",
  );
