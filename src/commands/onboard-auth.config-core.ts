...
export function applyZaiConfig(cfg: OpenHedgehogConfig): OpenHedgehogConfig {
...
export function applyOpenrouterProviderConfig(cfg: OpenHedgehogConfig): OpenHedgehogConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyVercelAiGatewayProviderConfig(cfg: OpenHedgehogConfig): OpenHedgehogConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyVercelAiGatewayConfig(cfg: OpenHedgehogConfig): OpenHedgehogConfig {
...
export function applyOpenrouterConfig(cfg: OpenHedgehogConfig): OpenHedgehogConfig {
...
export function applyMoonshotProviderConfig(cfg: OpenHedgehogConfig): OpenHedgehogConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyMoonshotConfig(cfg: OpenHedgehogConfig): OpenHedgehogConfig {
...
export function applyKimiCodeProviderConfig(cfg: OpenHedgehogConfig): OpenHedgehogConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyKimiCodeConfig(cfg: OpenHedgehogConfig): OpenHedgehogConfig {
...
export function applySyntheticProviderConfig(cfg: OpenHedgehogConfig): OpenHedgehogConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applySyntheticConfig(cfg: OpenHedgehogConfig): OpenHedgehogConfig {
...
export function applyXiaomiProviderConfig(cfg: OpenHedgehogConfig): OpenHedgehogConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyXiaomiConfig(cfg: OpenHedgehogConfig): OpenHedgehogConfig {
 ...
 */
export function applyVeniceProviderConfig(cfg: OpenHedgehogConfig): OpenHedgehogConfig {
  const models = { ...cfg.agents?.defaults?.models };
 ...
 */
export function applyVeniceConfig(cfg: OpenHedgehogConfig): OpenHedgehogConfig {
