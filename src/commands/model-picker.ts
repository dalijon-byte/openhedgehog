...
function resolveConfiguredModelRaw(cfg: OpenHedgehogConfig): string {
...
function resolveConfiguredModelKeys(cfg: OpenHedgehogConfig): string[] {
...
export function applyPrimaryModel(cfg: OpenHedgehogConfig, model: string): OpenHedgehogConfig {
...
export function applyModelAllowlist(cfg: OpenHedgehogConfig, models: string[]): OpenHedgehogConfig {
  const defaults = cfg.agents?.defaults;
