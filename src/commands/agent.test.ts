...
async function withTempHome<T>(fn: (home: string) => Promise<T>): Promise<T> {
  return withTempHomeBase(fn, { prefix: "openhedgehog-agent-" });
}

function mockConfig(
  home: string,
  storePath: string,
  agentOverrides?: Partial<NonNullable<NonNullable<OpenHedgehogConfig["agents"]>["defaults"]>>,
  telegramOverrides?: Partial<NonNullable<OpenHedgehogConfig["telegram"]>>,
