...
export function summarizeExistingConfig(config: OpenHedgehogConfig): string {
  const rows: string[] = [];
...
export function formatControlUiSshHint(params: {
  ...
  return [
    ...
    authedUrl,
    "Docs:",
    "https://docs.openhedgehog.ai/gateway/remote",
    "https://docs.openhedgehog.ai/web/control-ui",
  ]
    .filter(Boolean)
    .join("\n");
}
