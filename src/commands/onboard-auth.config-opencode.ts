...
export function applyOpencodeZenProviderConfig(cfg: OpenHedgehogConfig): OpenHedgehogConfig {
...
export function applyOpencodeZenConfig(cfg: OpenHedgehogConfig): OpenHedgehogConfig {
