...
function resolveDefaultAccountId(cfg: OpenHedgehogConfig, provider: ChannelId): string {
...
function shouldShowProviderEntry(entry: ProviderAccountStatus, cfg: OpenHedgehogConfig): boolean {
...
export function summarizeBindings(cfg: OpenHedgehogConfig, bindings: AgentBinding[]): string[] {
