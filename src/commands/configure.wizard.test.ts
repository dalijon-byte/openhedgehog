...
vi.mock("../config/config.js", () => ({
  CONFIG_PATH: "~/.openhedgehog/openhedgehog.json",
...
vi.mock("./onboard-helpers.js", () => ({
  DEFAULT_WORKSPACE: "~/.openhedgehog/workspace",
  applyWizardMetadata: (cfg: OpenHedgehogConfig) => cfg,
...
describe("runConfigureWizard", () => {
  it("persists gateway.mode=local when only the run mode is selected", async () => {
    ...
    mocks.resolveControlUiLinks.mockReturnValue({ wsUrl: "ws://127.0.0.1:18798" });
