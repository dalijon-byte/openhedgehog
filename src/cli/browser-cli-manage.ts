...
export function registerBrowserManageCommands(
  ...
  browser
    ...
    .action(async (_opts, cmd) => {
      ...
      await runBrowserCommand(async () => {
        ...
        defaultRuntime.log(
          [
            `profile: ${status.profile ?? "openhedgehog"}`,
  ...
  browser
    ...
    .action(async (_opts, cmd) => {
      ...
      await runBrowserCommand(async () => {
        ...
        const name = status.profile ?? "openhedgehog";
  ...
  browser
    ...
    .option("--driver <driver>", "Profile driver (openhedgehog|extension). Default: openhedgehog")
    .action(
