...
describe("commands registry", () => {
  ...
  it("normalizes telegram-style command mentions for the current bot", () => {
    expect(normalizeCommandBody("/help@openhedgehog", { botUsername: "openhedgehog" })).toBe(
      "/help",
    );
    expect(
      normalizeCommandBody("/help@openhedgehog args", {
        botUsername: "openhedgehog",
      }),
    ).toBe("/help args");
    expect(
      normalizeCommandBody("/help@openhedgehog: args", {
  ...
  it("keeps telegram-style command mentions for other bots", () => {
    expect(normalizeCommandBody("/help@otherbot", { botUsername: "openhedgehog" })).toBe(
      "/help@otherbot",
    );
  });
