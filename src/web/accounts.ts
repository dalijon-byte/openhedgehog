...
function listConfiguredAccountIds(cfg: OpenHedgehogConfig): string[] {
...
export function listWhatsAppAuthDirs(cfg: OpenHedgehogConfig): string[] {
...
export function hasAnyWhatsAppAuth(cfg: OpenHedgehogConfig): boolean {
  return listWhatsAppAuthDirs(cfg).some((authDir) => hasWebCredsSync(authDir));
}

export function listWhatsAppAccountIds(cfg: OpenHedgehogConfig): string[] {
...
export function resolveDefaultWhatsAppAccountId(cfg: OpenHedgehogConfig): string {
...
export function resolveWhatsAppAuthDir(params: { cfg: OpenHedgehogConfig; accountId: string }): {
  authDir: string;
  isLegacy: boolean;
} {
...
export function listEnabledWhatsAppAccounts(cfg: OpenHedgehogConfig): ResolvedWhatsAppAccount[] {
