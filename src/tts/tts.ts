...
export function resolveTtsConfig(cfg: OpenHedgehogConfig): ResolvedTtsConfig {
...
export function resolveTtsPrefsPath(config: ResolvedTtsConfig): string {
  ...
  const envPath = process.env.OPENHEDGEHOG_TTS_PREFS?.trim();
  if (envPath) {
...
export function buildTtsSystemPromptHint(cfg: OpenHedgehogConfig): string | undefined {
