...
export function listSignalAccountIds(cfg: OpenHedgehogConfig): string[] {
...
export function resolveDefaultSignalAccountId(cfg: OpenHedgehogConfig): string {
...
function mergeSignalAccountConfig(cfg: OpenHedgehogConfig, accountId: string): SignalAccountConfig {
...
export function listEnabledSignalAccounts(cfg: OpenHedgehogConfig): ResolvedSignalAccount[] {
