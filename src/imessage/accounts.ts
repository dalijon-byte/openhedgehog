...
export function listIMessageAccountIds(cfg: OpenHedgehogConfig): string[] {
...
export function resolveDefaultIMessageAccountId(cfg: OpenHedgehogConfig): string {
...
export function listEnabledIMessageAccounts(cfg: OpenHedgehogConfig): ResolvedIMessageAccount[] {
