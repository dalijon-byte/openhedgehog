...
export const normalizePluginsConfig = (
  config?: OpenHedgehogConfig["plugins"],
...
const hasExplicitMemorySlot = (plugins?: OpenHedgehogConfig["plugins"]) =>
  Boolean(plugins?.slots && Object.prototype.hasOwnProperty.call(plugins.slots, "memory"));

const hasExplicitMemoryEntry = (plugins?: OpenHedgehogConfig["plugins"]) =>
  Boolean(plugins?.entries && Object.prototype.hasOwnProperty.call(plugins.entries, "memory-core"));

const hasExplicitPluginConfig = (plugins?: OpenHedgehogConfig["plugins"]) => {
  if (!plugins) {
    return false;
  }
