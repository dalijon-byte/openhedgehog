...
import {
  ...
  type OpenHedgehogPackageManifest,
...
function deriveIdHint(params: {
  ...
  // package is scoped (example: @openhedgehog/voice-call -> voice-call).
...
export function discoverOpenHedgehogPlugins(params: {
  workspaceDir?: string;
  extraPaths?: string[];
  ...
  if (workspaceDir) {
    ...
    const workspaceExtDirs = [path.join(workspaceRoot, ".openhedgehog", "extensions")];
