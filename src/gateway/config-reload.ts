...
export function resolveGatewayReloadSettings(cfg: OpenHedgehogConfig): GatewayReloadSettings {
...
export function startGatewayConfigReloader(opts: {
  initialConfig: OpenHedgehogConfig;
  readSnapshot: () => Promise<ConfigFileSnapshot>;
  onHotReload: (plan: GatewayReloadPlan, nextConfig: OpenHedgehogConfig) => Promise<void>;
  onRestart: (plan: GatewayReloadPlan, nextConfig: OpenHedgehogConfig) => void;
  log: {
