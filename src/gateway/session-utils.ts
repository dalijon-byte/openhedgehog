...
import { type OpenHedgehogConfig, loadConfig } from "../config/config.js";
...
function listConfiguredAgentIds(cfg: OpenHedgehogConfig): string[] {
...
export function listAgentsForGateway(cfg: OpenHedgehogConfig): {
  defaultId: string;
  mainKey: string;
  scope: SessionScope;
...
function resolveDefaultStoreAgentId(cfg: OpenHedgehogConfig): string {
...
function resolveSessionStoreAgentId(cfg: OpenHedgehogConfig, canonicalKey: string): string {
...
export function loadCombinedSessionStoreForGateway(cfg: OpenHedgehogConfig): {
  storePath: string;
...
export function getSessionDefaults(cfg: OpenHedgehogConfig): GatewaySessionsDefaults {
