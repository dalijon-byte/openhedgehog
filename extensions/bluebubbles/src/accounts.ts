...
export function listBlueBubblesAccountIds(cfg: OpenHedgehogConfig): string[] {
...
export function resolveDefaultBlueBubblesAccountId(cfg: OpenHedgehogConfig): string {
...
export function listEnabledBlueBubblesAccounts(cfg: OpenHedgehogConfig): ResolvedBlueBubblesAccount[] {
