...
export function listZalouserAccountIds(cfg: OpenHedgehogConfig): string[] {
...
export function resolveDefaultZalouserAccountId(cfg: OpenHedgehogConfig): string {
...
function mergeZalouserAccountConfig(cfg: OpenHedgehogConfig, accountId: string): ZalouserAccountConfig {
