...
export function listGoogleChatAccountIds(cfg: OpenHedgehogConfig): string[] {
...
export function resolveDefaultGoogleChatAccountId(cfg: OpenHedgehogConfig): string {
...
export function listEnabledGoogleChatAccounts(cfg: OpenHedgehogConfig): ResolvedGoogleChatAccount[] {
