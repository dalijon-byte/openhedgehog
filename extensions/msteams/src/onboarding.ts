...
function setMSTeamsDmPolicy(cfg: OpenHedgehogConfig, dmPolicy: DmPolicy) {
  const allowFrom =
    dmPolicy === "open"
...
function setMSTeamsAllowFrom(cfg: OpenHedgehogConfig, allowFrom: string[]): OpenHedgehogConfig {
  return {
    ...cfg,
    channels: {
      ...cfg.channels,
