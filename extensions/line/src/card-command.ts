import type { LineChannelData, OpenHedgehogPluginApi, ReplyPayload } from "openhedgehog/plugin-sdk";
import {
  createActionCard,
  createImageCard,
  createInfoCard,
...
export function registerLineCardCommand(api: OpenHedgehogPluginApi): void {
  api.registerCommand({
    name: "card",
