import type { ChannelOnboardingAdapter, OpenHedgehogConfig, WizardPrompter } from "openhedgehog/plugin-sdk";
...
async function noteMattermostSetup(prompter: WizardPrompter): Promise<void> {
  await prompter.note(
    [
      ...
      "Docs: https://docs.openhedgehog.ai/channels/mattermost",
    ].join("\n"),
...
export const mattermostOnboardingAdapter: ChannelOnboardingAdapter = {
  ...
  disable: (cfg: OpenHedgehogConfig) => ({
    ...cfg,
    channels: {
      ...cfg.channels,
