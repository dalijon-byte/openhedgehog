...
export function listMattermostAccountIds(cfg: OpenHedgehogConfig): string[] {
...
export function resolveDefaultMattermostAccountId(cfg: OpenHedgehogConfig): string {
...
export function listEnabledMattermostAccounts(cfg: OpenHedgehogConfig): ResolvedMattermostAccount[] {
