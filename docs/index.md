...
- **Open the dashboard (local Gateway):** http://127.0.0.1:18798/ (or http://localhost:18798/)
...
Local default: http://127.0.0.1:18798/
...
WhatsApp / Telegram / Discord / iMessage (+ plugins)
        ...
        ▼
  ┌───────────────────────────┐
  │          Gateway          │  ws://127.0.0.1:18798 (loopback-only)
  │     (single source)       │
...
- **Loopback-first**: Gateway WS defaults to `ws://127.0.0.1:18798`.
