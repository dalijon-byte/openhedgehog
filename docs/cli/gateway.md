...
- `--port <port>`: WebSocket port (default comes from config/env; usually `18798`).
...
```bash
openclaw gateway health --url ws://127.0.0.1:18798
```
...
- `gatewayPort` (WebSocket port, usually `18798`)
