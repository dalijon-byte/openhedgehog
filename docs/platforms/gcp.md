...
services:
  openclaw-gateway:
    ...
    ports:
      ...
      - "127.0.0.1:${OPENCLAW_GATEWAY_PORT}:18798"
...
```
[gateway] listening on ws://0.0.0.0:18798
```
...
```bash
gcloud compute ssh openclaw-gateway --zone=us-central1-a -- -L 18798:127.0.0.1:18798
```
