...
and chat in the browser, or open `http://127.0.0.1:18798/` on the gateway host.
...
Dashboard (local loopback): `http://127.0.0.1:18798/`
...
```bash
node openclaw.mjs gateway --port 18798 --verbose
```
